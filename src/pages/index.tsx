  ...
  return (
    <>
      ...
      <div className="md:hidden lg:hidden flex mt-[15vh] flex-col justify-center items-center">
        ...
        <h2 className="bg-white rounded-md mx-1 font-semibold text-sm">{data && data[0].title}</h2>
        <p className="mt-2 bg-white rounded-md mx-1 mb-2 text-sm">{data && data[0].body}</p>
        <Link href="/post/1" className="bg-white mx-1 rounded-r-full rounded-l-full px-1 py-1 text-sm">Read more →</Link>
        </div>
